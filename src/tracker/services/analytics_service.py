"""
Сервис аналитики гонки
Перенесён из tracker/server/analytics_service.py с обновленными импортами
"""
...
def format_time(seconds: float) -> str:
    """Форматировать время (в секундах) в HH:MM:SS"""
...
def get_formatted_analytics():
    ...
    try:
        ...
        with open(settings.RACE_DATA_FILE, 'r', encoding='utf-8') as file:
            data = json.load(file)
