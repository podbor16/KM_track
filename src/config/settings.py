...
EVENTS_CONFIG: Dict[str, Dict[str, Any]] = {
    ...
    'vesna': {
        ...
        'name': 'Весна',
        'title': 'Весна | Трекер',
        'description': 'Событие Весна'
    },
    'colorrun': {
        'osm_way_id': 0,
        'name': 'Красочный забег',
        'title': 'Красочный забег | Трекер',
        'description': 'Событие Красочный забег'
    },
    'girlseven': {
        'osm_way_id': 0,
        'name': 'Женская семерка',
        'title': 'Женская семерка | Трекер',
        'description': 'Событие Женская семерка'
    },
    'zhara': {
        'osm_way_id': 0,
        'name': 'Жара',
        'title': 'Жара | Трекер',
        'description': 'Событие Жара'
    },
    'kids': {
        'osm_way_id': 0,
        'name': 'Детский забег',
        'title': 'Детский забег | Трекер',
        'description': 'Событие Детский забег'
    },
    'xtrailrun': {
        'osm_way_id': 0,
        'name': 'Х Трейл',
        'title': 'Х Трейл | Трекер',
        'description': 'Событие Х Трейл'
    },
    'snow7': {
