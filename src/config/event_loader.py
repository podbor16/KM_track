...
class DiplomaConfig(BaseModel):
    ...
    # Фраза в нижней плашке диплома участника (participant_only) — по полу
    # из заявки ("Бегал/Бегала в лесу и понравилось"); "\n" — перенос строки.
    participant_text_male: str | None = None
    participant_text_female: str | None = None
