...
EVENTS_CONFIG = {
    ...
    'night_run': {
        'osm_way_id': 316087424,
        'one_way_length_km': 2.5,  # Половина маршрута в одну сторону
        'total_race_km': 5.0,       # Полная дистанция (туда 2.5 км + обратно 2.5 км)
        'distances': {
            '2km': {'one_way_length': 1.0, 'total_race': 2.0},    # 1 км туда, 1 км обратно
            '5km': {'one_way_length': 2.5, 'total_race': 5.0},    # 2.5 км туда, 2.5 км обратно
        },
        'name': 'Ночной забег',
        'title': '🏃 Трекер Ночного забега',
        'description': 'Набережная, Красноярск | Дистанции: 2 км, 5 км'
    }
}
