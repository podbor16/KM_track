...
PARTICIPANTS = [
    ...
    (1,  "Иванов",     "Алексей",  "M", "individual"),
    (2,  "Петров",     "Дмитрий",  "M", "individual"),
    (3,  "Сидоров",    "Михаил",   "M", "individual"),
    (4,  "Кузнецов",   "Андрей",   "M", "individual"),
    (5,  "Новиков",    "Сергей",   "M", "individual"),
    (6,  "Фёдоров",    "Павел",    "M", "individual"),
    (7,  "Морозова",   "Елена",    "F", "individual"),
    (8,  "Соколова",   "Анна",     "F", "individual"),
    (9,  "Попова",     "Мария",    "F", "individual"),
    (10, "Лебедев",    "Виктор",   "M", "individual"),
