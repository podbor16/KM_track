...
- [ ] **В пресет Copernico добавить поле даты рождения (`birthdate`)** — сейчас не приходит; без него `--init` создаст карточки-двойники с датой 1900-01-01
- [ ] `--init` (загрузка стартового списка в results)
