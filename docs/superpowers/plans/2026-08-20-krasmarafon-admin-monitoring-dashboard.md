...
- [x] **Step 1: Прогнать полный набор тестов перед живой проверкой**
...
- [x] **Step 2: Поднять локальный dev-сервер**
...
- [x] **Step 3: Открыть /admin и проверить вкладку «Мониторинг» через agent-browser**
...
- [x] **Step 4: Проверить обработку ошибок — до появления данных**
...
- [x] **Step 5: Остановить dev-сервер**
