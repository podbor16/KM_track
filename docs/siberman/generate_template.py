...
Плавание/бег — elapsed-время от старта этапа, как раньше.
Вело (день 1 и день 2) — АСТРОНОМИЧЕСКОЕ время (часы на табло/по местному
времени), не elapsed. Старт вело-2 больше не вводится вручную — считается
автоматически по рангу вело-1 (см. src/siberman/service.py:convert_bike_times_to_elapsed).
"""
import openpyxl
...
COLUMNS = [
    ...
    # "Плавание: " в тексте колонки (не только в объединённой row1-категории)
    # обязателен — иначе "N круг(а)" совпадает через startswith-эвристику
    # с одноимёнными колонками бега (см. CHECKPOINT_COL_MAP в parser.py).
    ("Плавание", "Плавание: разворот 1 (1,3 км)"),
    ("Плавание", "Плавание: 1 круг (2,6 км)"),
    ("Плавание", "Плавание: разворот 2 (3,9 км)"),
    ("Плавание", "Плавание: 2 круга (5,2 км)"),
    ("Плавание", "Плавание: разворот 3 (6,5 км)"),
    ("Плавание", "Плавание: 3 круга (7,8 км)"),
    ("Плавание", "Финиш 10 км (плавание, 4 круг)"),
    ("Вело день 1", "3 км"),
    ("Вело день 1", "10 км"),
